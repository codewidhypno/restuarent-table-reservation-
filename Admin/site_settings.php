...
if(isset($_POST['submit'])){
    ...
    $sql   = "INSERT INTO tbl_auth_users(auth_name, auth_email, auth_status)VALUES('$auth_name', '$auth_email','$status') ";
    $exec  = mysqli_query($con,$sql);
    if($exec){
        echo "<script>alert('New Auth User Added');</script>";
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-table mr-1"></i>NEW EMAIL</div>
                            <div class="card-body">
                              
                                       <form actio="#" method="POST">
                                        <div class="form-row">
                                          <div class="col-5">
                                            <input type="text" class="form-control" placeholder="Enter Name" name="auth_name">
                                          </div>
                                          <div class="col-5">
                                            <input type="email" class="form-control" placeholder="Enter email" name="auth_email">
                                          </div>
                                          <div class="col-2">
